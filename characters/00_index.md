# Pre-Generated Characters: The Twisted Thicket

*Eight OSRIC-compatible pre-generated characters for 4–6 players, levels 5–7. Select any combination, or roll 1d8 for random assignment. The party functions with as few as four; all eight have been equipped to cover the adventure's key challenges.*
...
| 6 | [06](06_brynn_ashwood.md) | Brynn Ashwood | Human Druid | 6 | Forest magic, cleansing rite support |
| 7 | [07](07_wulfric_stone.md) | Wulfric Stone | Dwarf Fighter | 5 | Whelm resonance, dwarf combat bonuses |
| 8 | [08](08_aldwyn_corr.md) | Aldwyn Corr | Human Paladin | 6 | Detect evil, divine investigation, party saves |
...
**The obsidian disc** (Area 3) can be identified by Mordechai with one round of concentration.
...
## What Each Character Knows at the Start

All characters arrive in Ringstown having survived the session zero event (the Coach B attack). They have:
- Seen the owlbear and know it is unnaturally large, fast, and luminescent
- Spoken briefly with Elnara at the gate
- No information yet about white plume dust, Sorel Vane, or the Inheritor's network

Individual hooks are noted in each character file.
