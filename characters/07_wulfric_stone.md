...
| Ability | Score | Notes |
|---------|-------|-------|
| Strength | 18/45 | +1 to hit, +3 damage |
| Dexterity | 12 | — |
...
|--------|--------|--------|-------|
| Warhammer +1 (own) | +2 | 1d4+1+4 = 1d4+5 | +1 magic, +1 to hit / +3 damage from Str |
| Whelm *(if found, Area 2)* | +2* | 1d4+1+4 = 1d4+5* | *See Whelm notes below* |
...
*Dwarf Constitution 17 grants +3 to all saving throws vs. magic and poison. Apply this bonus to all saves above when the source is magical or poison-based — including dust compulsion effects. Effective Wands save vs. magic: 8. Effective Spells save vs. magic: 11.*

---

## Dwarf Abilities

- **Detect stonework:** Wulfric can detect sloping passages, shifting walls, new construction, and depth below ground automatically when he concentrates for one round.
- **Darkvision:** 60 ft.
- **Attack bonus:** +1 to hit against goblinoids and orcs.
- **Magic resistance:** The Constitution bonus to saves already reflects this.

---

## Equipment

**Worn:** Plate mail, medium shield, warhammer +1 at belt, hand axe ×2 on belt, dagger in boot, ring on right hand  
**Pack:** 50 ft hempen rope, rations ×5, bedroll, lantern, flask of oil ×2, flint & steel, iron spikes ×10, small hammer (utility), whetstone, 2 sp worth of pipe tobacco and a short clay pipe  
**Coin:** 42 gp, 25 sp
...
- Does not elaborate. States facts, asks one question, proceeds. Has been told this is brusque. Considers brusque to be neutral.
- Deeply loyal to people he has worked with before. Calder is in this category. He would not say this out loud.
- Will not use the dust, not from moral principle but because he has watched what happens to soldiers who supplement their courage chemically, and the sequel is never worth the opening act.
