...
*Wisdom 17 grants one bonus 1st-level spell per day.*
...
|--------|--------|--------|-------|
| Mace +1 | +1 | 1d6+1 | St. Cuthbert's symbol; she considers it a reliquary |
| Heavy mace (backup) | +0 | 1d6+1 | Carried in pack |
| Sling | +0 | 1d4 | 20 lead bullets; range 5"/10"/20" |

*Clerics are restricted to blunt weapons.*
...
**Worn:** Chain mail, medium shield, mace +1, holy symbol (silver, cudgel design), ring on right hand  
**Pack:** Heavy mace, sling + 20 bullets, rations ×4, waterskin, bedroll, writing kit (journal, inkpot, quill), 3 vials holy water, healer's kit (full; 4 uses of bandaging, 1d3 hp each), candles ×6, tinderbox, copy of the Teachings of St. Cuthbert (small octavo, worn)  
**Coin:** 44 gp, 8 sp
...
- Takes notes on everything. Her journal now has twelve pages on dust symptom progression, four pages on the pool's theological parallels, and a sketch of the K-mark that she finds herself redrawing when she is thinking about something else.
- St. Cuthbert is a god of honesty and righteous retribution. Tessaly applies both: she is straightforwardly honest with the party about her objectives, and she will not leave an evil that can be ended, unended.
- She has administered last rites three times since arriving in Ringstown. She is tired in a way she does not mention.
