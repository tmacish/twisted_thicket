...
## Elnara, Ranger-Captain

A practical warden of the roadwoods, Elnara wants the threat ended and the dust destroyed.

**AC** 4; **Class** Ranger 6; **hp** 34; **MV** 120 ft.  
**Attacks** longsword or longbow  
**Str** 14, **Int** 11, **Wis** 13, **Dex** 16, **Con** 14, **Cha** 12

*On being named:* If the party connects her to the cover name "E. Forger" (Blink's manifest) or the routing note signed *E.* (weapon-convoy manifest), she will not confirm or deny the name; she adds 10 gp to the commission without explanation and says nothing further.

---

## Sorel Vane, Smuggler Lieutenant

Sorel ran the distribution leg of the dust network in the Thicket, dispatching crew to manage cargo movement without making the runs himself. He was not at the Coach B crash site. He knows the dust came from buyers connected to "a mind in the mountain."

**AC** 5; **Class** Fighter 4; **hp** 27; **MV** 120 ft.  
**Attacks** short sword, dagger, or light crossbow  
...
## Old Brindle, Hermit Druid

This ragged guardian watches the glade in Area 4 and believes the forest itself is becoming feverish from the powder.

**AC** 7; **Class** Druid 5; **hp** 24; **MV** 120 ft.  
**Attacks** staff or sling  
**Suggested spells:** *cure light wounds*, *entangle*, *faerie fire*, *hold animal*  
**Typical spells (full load):** *locate plants or animals*, *entangle*, *faerie fire*, *hold animal*, *speak with animals*; currently reduced to *cure light wounds* (1) only.
...
**AC** 6; **HD** 1-1; **hp** 3 each; **MV** 90 ft.  
